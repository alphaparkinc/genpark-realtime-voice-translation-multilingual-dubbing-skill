# genpark-realtime-voice-translation-multilingual-dubbing-skill
...
> **GenPark AI Agent Skill** -- Real-time multilingual voice translation and dubbing pipeline with sub-500ms latency (LiveKit style)
